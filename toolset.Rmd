...
generating [305(b) and 303(d) lists for the Integrated Report on water quality conditions in the state of Utah](){target="_blank"}. This suite of tools includes functions for screening water quality data 
...
developments have included the [Utah Lake Data Explorer](){target="_blank"} and the [COVID-19 wastewater monitoring dashboard](){target="_blank"}. These types of tools are highly flexible and can be used as standalone applications or embedded 
into other webpages for additional context.
<br>
